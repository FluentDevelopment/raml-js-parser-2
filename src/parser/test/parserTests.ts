...
describe('Parser regression tests', function () {
    ...
    it ("custom facets validator" ,function(){
        testErrors(util.data("commonLibrary/api.raml"), ["Expected type 'object' but got 'string'","Expected type 'object' but got 'string'","Expected type 'string' but got 'number'"]);
    })
